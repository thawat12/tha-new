...
import 'package:ViewNews/news_view.dart';
import 'package:flutter/material.dart';
import 'package:ViewNews/drawer_menu.dart';
...
class _NewsPageState extends State<NewsPage> {
  ...
  Future<String> _GetNewsAPI() async {
    var response = await Http.get(
        'http://newsapi.org/v2/top-headlines?country=th&category=business&apiKey=a1f7096901f24f29afd95b1d3ed9e710');
